...
/* TODO:
- Test the protocols array content in test wsio_create_for_secure_connection_with_valid_args_succeeds
*/
...
static const OPTIONHANDLER_HANDLE TEST_UWS_CLIENT_OPTIONHANDLER_HANDLE = (OPTIONHANDLER_HANDLE)0x4246;
...
pfCloneOption g_clone_option;
pfDestroyOption g_destroy_option;
pfSetOption g_set_option;
...
static int my_uws_close(UWS_CLIENT_HANDLE uws, ON_WS_CLOSE_COMPLETE on_ws_close_complete, void* on_ws_close_complete_context)
{
    (void)uws;
...
static int my_uws_send_frame(UWS_CLIENT_HANDLE uws, unsigned char frame_type, const unsigned char* buffer, size_t size, bool is_final, ON_WS_SEND_FRAME_COMPLETE on_ws_send_frame_complete, void* on_ws_send_frame_complete_context)
{
    (void)uws;
    (void)buffer;
    (void)size;
...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    default_wsio_config.use_ssl = true;
    ...
    REGISTER_GLOBAL_MOCK_HOOK(uws_client_open, my_uws_open);
    REGISTER_GLOBAL_MOCK_HOOK(uws_client_close, my_uws_close);
    REGISTER_GLOBAL_MOCK_HOOK(uws_client_send_frame, my_uws_send_frame);
    ...
    REGISTER_GLOBAL_MOCK_RETURN(uws_client_create, TEST_UWS_HANDLE);
...
/* Tests_SRS_WSIO_01_070: [ The underlying uws instance shall be created by calling `uws_client_create`. ]*/
/* Tests_SRS_WSIO_01_071: [ The arguments for `uws_client_create` shall be: ]*/
...
TEST_FUNCTION(wsio_create_for_secure_connection_with_valid_args_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(uws_client_create(TEST_HOST_ADDRESS, 443, TEST_RESOURCE_NAME, true, IGNORED_PTR_ARG, 1))
        .IgnoreArgument_protocols();
    STRICT_EXPECTED_CALL(singlylinkedlist_create());

	// act
    wsio = wsio_create(&default_wsio_config);
...
TEST_FUNCTION(wsio_create_with_NULL_hostname_field_fails)
{
    ...
    wsio_config.use_ssl = true;

    // act
    wsio = wsio_create(&wsio_config);
...
/* Tests_SRS_WSIO_01_075: [ If `uws_client_create` fails, then `wsio_create` shall fail and return NULL. ]*/
...
TEST_FUNCTION(wsio_create_for_secure_connection_with_valid_args_succeeds_2)
{
    ...
    wsio_config.use_ssl = false;

    EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
    STRICT_EXPECTED_CALL(uws_client_create("another.com", 80, "haga", false, IGNORED_PTR_ARG, 1))
        .IgnoreArgument_protocols();
    STRICT_EXPECTED_CALL(singlylinkedlist_create());
...
/* Tests_SRS_WSIO_01_082: [ `wsio_open` shall open the underlying uws instance by calling `uws_client_open` and providing the uws handle created in `wsio_create` as argument. ]*/
...
TEST_FUNCTION(wsio_open_opens_the_underlying_uws_instance)
{
    ...
    STRICT_EXPECTED_CALL(uws_client_open(TEST_UWS_HANDLE, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
        .IgnoreArgument_on_ws_open_complete()
        .IgnoreArgument_on_ws_open_complete_context()
        .IgnoreArgument_on_ws_frame_received()
        .IgnoreArgument_on_ws_frame_received_context()
        .IgnoreArgument_on_ws_peer_closed()
        .IgnoreArgument_on_ws_peer_closed_context()
        .IgnoreArgument_on_ws_error()
        .IgnoreArgument_on_ws_error_context();

    // act
    result = wsio_open(wsio, test_on_io_open_complete, (void*)0x4242, test_on_bytes_received, (void*)0x4243, test_on_io_error, (void*)0x4244);
...
TEST_FUNCTION(wsio_open_when_already_opening_fails)
{
    ...
    int result;
    wsio = wsio_create(&default_wsio_config);
    (void)wsio_open(wsio, test_on_io_open_complete, (void*)0x4242, test_on_bytes_received, (void*)0x4243, test_on_io_error, (void*)0x4244);
    umock_c_reset_all_calls();
...
TEST_FUNCTION(wsio_open_with_NULL_handle_fails)
{
    ...
    // act
    result = wsio_open(NULL, test_on_io_open_complete, (void*)0x4242, test_on_bytes_received, (void*)0x4243, test_on_io_error, (void*)0x4244);
...
TEST_FUNCTION(wsio_open_with_NULL_on_open_complete_callback_fails)
{
    ...
    // act
    result = wsio_open(wsio, NULL, (void*)0x4242, test_on_bytes_received, (void*)0x4243, test_on_io_error, (void*)0x4244);
...
TEST_FUNCTION(wsio_open_with_NULL_on_bytes_received_callback_fails)
{
    ...
    // act
    result = wsio_open(wsio, test_on_io_open_complete, (void*)0x4242, NULL, (void*)0x4243, test_on_io_error, (void*)0x4244);
...
TEST_FUNCTION(wsio_open_with_NULL_on_io_error_callback_fails)
{
    ...
    // act
    result = wsio_open(wsio, test_on_io_open_complete, (void*)0x4242, test_on_bytes_received, (void*)0x4243, NULL, (void*)0x4244);
...
TEST_FUNCTION(wsio_open_after_close_succeeds)
{
    ...
    (void)wsio_open(wsio, test_on_io_open_complete, (void*)0x4242, test_on_bytes_received, (void*)0x4243, test_on_io_error, (void*)0x4244);
    g_on_ws_open_complete(g_on_ws_open_complete_context, WS_OPEN_OK);
    (void)wsio_close(wsio, test_on_io_close_complete, (void*)0x4245);
...
/* Tests_SRS_WSIO_01_087: [ `wsio_close` shall call `uws_client_close` while passing as argument the IO handle created in `wsio_create`.  ]*/
...
TEST_FUNCTION(wsio_close_when_IO_is_open_closes_the_uws)
{
    ...
    STRICT_EXPECTED_CALL(uws_client_close(TEST_UWS_HANDLE, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
        .IgnoreArgument_on_ws_close_complete()
        .IgnoreArgument_on_ws_close_complete_context();
    STRICT_EXPECTED_CALL(singlylinkedlist_get_head_item(TEST_SINGLYLINKEDSINGLYLINKEDLIST_HANDLE));

    // act
    result = wsio_close(wsio, test_on_io_close_complete, (void*)0x4245);
...
TEST_FUNCTION(wsio_close_with_NULL_handle_fails)
{
    ...
    // act
    result = wsio_close(NULL, test_on_io_close_complete, (void*)0x4245);
...
TEST_FUNCTION(wsio_close_with_NULL_close_complete_callback_succeeds)
{
    ...
    // act
    result = wsio_close(wsio, NULL, NULL);
...
TEST_FUNCTION(wsio_close_indicates_a_pending_send_as_CANCELLED)
{
    ...
    (void)wsio_open(wsio, test_on_io_open_complete, (void*)0x4242, test_on_bytes_received, (void*)0x4243, test_on_io_error, (void*)0x4244);
    g_on_ws_open_complete(g_on_ws_open_complete_context, WS_OPEN_OK);
    (void)wsio_send(wsio, test_buffer, sizeof(test_buffer), test_on_send_complete, (void*)0x4343);
    umock_c_reset_all_calls();
...
/* Tests_SRS_WSIO_01_095: [ `wsio_send` shall call `uws_client_send_frame`, passing the `buffer` and `size` arguments as they are: ]*/
...
TEST_FUNCTION(wsio_send_with_1_byte_calls_uws_send_frame)
{
    ...
    STRICT_EXPECTED_CALL(singlylinkedlist_add(TEST_SINGLYLINKEDSINGLYLINKEDLIST_HANDLE, IGNORED_PTR_ARG))
        .IgnoreArgument_item();
    STRICT_EXPECTED_CALL(uws_client_send_frame(TEST_UWS_HANDLE, WS_FRAME_TYPE_BINARY, IGNORED_PTR_ARG, sizeof(test_buffer), true, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
        .IgnoreArgument_on_ws_send_frame_complete()
        .IgnoreArgument_callback_context()
        .ValidateArgumentBuffer(3, test_buffer, sizeof(test_buffer));

    // act
    result = wsio_send(wsio, test_buffer, sizeof(test_buffer), test_on_send_complete, (void*)0x4343);
...
TEST_FUNCTION(wsio_send_with_NULL_wsio_fails)
{
    ...
    // act
    result = wsio_send(NULL, test_buffer, sizeof(test_buffer), test_on_send_complete, (void*)0x4343);
...
TEST_FUNCTION(wsio_send_with_NULL_buffer_fails)
{
    ...
    // act
    result = wsio_send(wsio, NULL, 1, test_on_send_complete, (void*)0x4343);
...
TEST_FUNCTION(wsio_send_with_zero_size_fails)
{
    ...
    // act
    result = wsio_send(wsio, test_buffer, 0, test_on_send_complete, (void*)0x4343);
...
TEST_FUNCTION(wsio_send_with_NULL_send_complete_callback_succeeds)
{
    ...
    // act
    result = wsio_send(wsio, test_buffer, sizeof(test_buffer), NULL, (void*)0x4343);
...
TEST_FUNCTION(when_on_underlying_ws_open_complete_is_called_when_CLOSING_it_does_nothing)
{
    ...
    (void)wsio_open(wsio, test_on_io_open_complete, (void*)0x4242, test_on_bytes_received, (void*)0x4243, test_on_io_error, (void*)0x4244);
    g_on_ws_open_complete(g_on_ws_open_complete_context, WS_OPEN_OK);
    wsio_close(wsio, test_on_io_close_complete, (void*)0x4245);
    umock_c_reset_all_calls();
...
TEST_FUNCTION(when_on_underlying_ws_frame_received_is_called_the_frame_content_is_indicated_up_with_the_proper_context)
{
    ...
    wsio = wsio_create(&default_wsio_config);
    (void)wsio_open(wsio, test_on_io_open_complete, (void*)0x4242, test_on_bytes_received, NULL, test_on_io_error, (void*)0x4244);
    g_on_ws_open_complete(g_on_ws_open_complete_context, WS_OPEN_OK);
    umock_c_reset_all_calls();
...
TEST_FUNCTION(wsio_setoption_with_NULL_handle_fails)
{
    ...
    // act
    result = wsio_setoption(NULL, "option1", (void*)0x4242);
...
TEST_FUNCTION(wsio_setoption_with_NULL_option_fails)
{
    ...
    // act
    result = wsio_setoption(wsio, NULL, (void*)0x4242);
...
TEST_FUNCTION(wsio_setoption_with_WSIOOptions_feeds_the_options_to_the_underlying_layer)
{
    ...
    // act
    result = wsio_setoption(wsio, "WSIOOptions", (void*)TEST_OPTIONHANDLER_HANDLE);
...
TEST_FUNCTION(wsio_setoption_passes_the_option_dows_to_uws)
{
    ...
    // act
    result = wsio_setoption(wsio, "option1", (void*)0x4242);
...
TEST_FUNCTION(wsio_retrieveoptions_with_NULL_handle_fails)
{
    ...
    // act
    result = wsio_retrieveoptions(NULL);
...
TEST_FUNCTION(wsio_retrieveoptions_creates_an_option_handler_with_the_value_obtained_from_the_underlying_retrieve_options)
{
    ...
    // act
    result = wsio_retrieveoptions(wsio);
...
TEST_FUNCTION(wsio_clone_option_with_NULL_name_fails)
{
    ...
    wsio = wsio_create(&default_wsio_config);
    (void)wsio_retrieveoptions(wsio);
    umock_c_reset_all_calls();
...
/* Tests_SRS_WSIO_01_171: [ `wsio_clone_option` called with `name` being `WSIOOptions` shall clone the options by calling `OptionHandler_Clone`. ]*/
...
/* Tests_SRS_WSIO_01_172: [ If `OptionHandler_Clone` fails, `wsio_clone_option` shall fail and return NULL. ]*/
TEST_FUNCTION(when_OptionHandler_Clone_fails_wsio_clone_option_also_fails)
{
    // arrange
    CONCRETE_IO_HANDLE wsio;
    void* result;
...
TEST_FUNCTION(when_on_close_complete_was_NULL_on_underlying_ws_close_complete_does_not_trigger_any_callback)
{
    ...
    (void)wsio_open(wsio, test_on_io_open_complete, (void*)0x4242, test_on_bytes_received, (void*)0x4243, test_on_io_error, (void*)0x4244);
    g_on_ws_open_complete(g_on_ws_open_complete_context, WS_OPEN_OK);
    (void)wsio_close(wsio, NULL, (void*)0x4245);
    umock_c_reset_all_calls();
